...
data_arg.add_argument('--data_length', type=int, default=10)
data_arg.add_argument('--train_num', type=int, default=1000000)
data_arg.add_argument('--valid_num', type=int, default=8192)
data_arg.add_argument('--test_num', type=int, default=8192)
...
train_arg.add_argument('--max_grad_norm', type=float, default=50.0, help='')
train_arg.add_argument('--checkpoint_secs', type=int, default=300, help='')
train_arg.add_argument('--entropy_reg', type=float, default=0.001, help='')
train_arg.add_argument('--beam_size', type=int, default=10, help='')
...
misc_arg.add_argument('--thread_num', type=int, default=4, help='')
# misc_arg.add_argument('--base_rate', type=float, default=1.0, help='')
